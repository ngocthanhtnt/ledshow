...
static unsigned char const earth[][5]={"子鼠","丑牛","寅虎","卯兔","辰龙","巳蛇","午马","未羊","申猴","酉鸡","戌狗","亥猪",};
								         ...
								         char *str)
{
	...
	unsigned char SEyear;
        ...
        StrCopy(&str[0],(unsigned char *)"甲子鼠年正月初一",15);
	...
	StrCopy(&str[0],(unsigned char *)  sky[SEyear%10],2);	//  甲
        StrCopy(&str[2],(unsigned char *)earth[SEyear%12],4);	//  子
	
        if(NLyear[2]==1)	StrCopy(&str[8],(unsigned char *)"正",2);
        ...
        else				StrCopy(&str[12],(unsigned char *)"初",2);
...
**          如:GetJieQiStr(2007,02,08,str) 返回str="距雨水11天"
** 输　入:  year        公历年
**          month       公历月
**          day         公历日
			         ...
			         char *str)
{
	...
	if(day==JQdate)                                 //今天正是一个节气日
	{
		...
		return 1;
	                                                ...
	                                                //今天不是一个节气日
        StrCopy(str,(unsigned char *)"距小寒??天",11);
