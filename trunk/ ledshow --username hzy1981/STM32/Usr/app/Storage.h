...
#define SDI_FILE_PARA_INDEX     0x1000
#define SDI_FILE_PARA_INDEX_BK0 0x2000
#define SDI_FILE_PARA_INDEX_BK1 0x3000
...
#define SDI_ZK_DATA       0xFFFF //字库文件
...
EXT INT32U Get_Storage_Data_Len(STORA_DI SDI);
...
EXT INT16U Read_Storage_Data_NoCS(STORA_DI SDI, INT32U Offset, INT16U Len, void* pDst, void* pDst_Start, INT16U DstLen);
EXT INT8U Write_Storage_Data_NoCS(STORA_DI SDI, INT32U Offset, void* pSrc, INT16U Len);
