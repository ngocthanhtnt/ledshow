...
#define LCD_LOG_SetHeader debug
#define LCD_UsrLog debug
#define LCD_ErrLog debug
#define LCD_DbgLog debug
#define LCD_LOG_SetFooter debug

#define STM_EVAL_PBGetState(X) RESET
