#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\dh_groups.c"
...
#line 16 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\dh_groups.c"
...
#line 18 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\dh_groups.c"
...
#line 19 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\dh_groups.c"
...
#line 20 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\dh_groups.c"


#line 69 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\dh_groups.c"




 
static const unsigned char dh_group5_generator[1] = { 0x02 };
...
#line 513 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\dh_groups.c"
...
#line 531 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\dh_groups.c"
};
...
struct wpabuf * dh_init(const struct dh_group *dh, struct wpabuf **priv)
{
	...
	*priv = wpabuf_alloc(dh->prime_len);
	...
	wpa_hexdump_buf_key(0, "DH: private value", *priv);
	...
	if (crypto_mod_exp(dh->generator, dh->generator_len,
			   ...
			   &pv_len) < 0) {
		wpabuf_free(pv);
		wpa_printf(0, "DH: crypto_mod_exp failed");
		return 0;
	}
	wpabuf_put(pv, pv_len);
	wpa_hexdump_buf(0, "DH: public value", pv);
				 ...
				 const struct dh_group *dh)
{
	...
	if (dh == 0 || peer_public == 0 || own_private == 0)
		return 0;
	...
	wpa_hexdump_buf_key(0, "DH: shared key", shared);
