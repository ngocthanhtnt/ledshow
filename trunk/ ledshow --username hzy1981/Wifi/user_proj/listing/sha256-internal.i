#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha256-internal.c"
...
#line 16 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha256-internal.c"
...
#line 18 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha256-internal.c"
...
#line 19 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha256-internal.c"
...
#line 20 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha256-internal.c"
...
#line 95 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha256-internal.c"
...
static int sha256_compress(struct sha256_state *md, unsigned char *buf)
{
	...
	for (i = 0; i < 16; i++)
		W[i] = ((((unsigned int) (buf + (4 * i))[0]) << 24) | (((unsigned int) (buf + (4 * i))[1]) << 16) | (((unsigned int) (buf + (4 * i))[2]) << 8) | ((unsigned int) (buf + (4 * i))[3]));
...
static int sha256_done(struct sha256_state *md, unsigned char *out)
{
	...
	do { (md->buf + 56)[0] = (unsigned char) (((unsigned long) (md->length)) >> 56); (md->buf + 56)[1] = (unsigned char) (((unsigned long) (md->length)) >> 48); (md->buf + 56)[2] = (unsigned char) (((unsigned long) (md->length)) >> 40); (md->buf + 56)[3] = (unsigned char) (((unsigned long) (md->length)) >> 32); (md->buf + 56)[4] = (unsigned char) (((unsigned long) (md->length)) >> 24); (md->buf + 56)[5] = (unsigned char) (((unsigned long) (md->length)) >> 16); (md->buf + 56)[6] = (unsigned char) (((unsigned long) (md->length)) >> 8); (md->buf + 56)[7] = (unsigned char) (((unsigned long) (md->length)) & 0xff); } while (0);
	sha256_compress(md, md->buf);

	 
	for (i = 0; i < 8; i++)
		do { (out + (4 * i))[0] = (unsigned char) ((((unsigned int) (md->state[i])) >> 24) & 0xff); (out + (4 * i))[1] = (unsigned char) ((((unsigned int) (md->state[i])) >> 16) & 0xff); (out + (4 * i))[2] = (unsigned char) ((((unsigned int) (md->state[i])) >> 8) & 0xff); (out + (4 * i))[3] = (unsigned char) (((unsigned int) (md->state[i])) & 0xff); } while (0);
