#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha256.c"
...
#line 16 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha256.c"
...
#line 18 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha256.c"
...
#line 19 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha256.c"
...
#line 20 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha256.c"
		...
		const unsigned char *data, size_t data_len, unsigned char *buf, size_t buf_len)
{
	...
	do { (length_le)[1] = ((unsigned short) (buf_len * 8)) >> 8; (length_le)[0] = ((unsigned short) (buf_len * 8)) & 0xff; } while (0);
	pos = 0;
	while (pos < buf_len) {
		plen = buf_len - pos;
		do { (counter_le)[1] = ((unsigned short) (counter)) >> 8; (counter_le)[0] = ((unsigned short) (counter)) & 0xff; } while (0);
		if (plen >= 32) {
