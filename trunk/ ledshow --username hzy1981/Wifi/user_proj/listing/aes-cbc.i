#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-cbc.c"
...
#line 17 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-cbc.c"
...
#line 19 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-cbc.c"
...
#line 20 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-cbc.c"
...
#line 21 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-cbc.c"
...
int aes_128_cbc_encrypt(const unsigned char *key, const unsigned char *iv, unsigned char *data, size_t data_len)
{
	void *ctx;
...
int aes_128_cbc_decrypt(const unsigned char *key, const unsigned char *iv, unsigned char *data, size_t data_len)
{
	void *ctx;
	unsigned char cbc[16], tmp[16];
	unsigned char *pos = data;
	int i, j, blocks;
	...
	blocks = data_len / 16;
	for (i = 0; i < blocks; i++) {
		os_memcpy(tmp, pos, 16);
		aes_decrypt(ctx, pos, pos);
		for (j = 0; j < 16; j++)
			pos[j] ^= cbc[j];
		os_memcpy(cbc, tmp, 16);
		pos += 16;
	}
