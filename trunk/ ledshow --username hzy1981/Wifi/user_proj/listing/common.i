...
#line 2 "..\\sdio\\src\\common.c"
#line 3 "..\\sdio\\src\\common.c"
int g_random;
...
const char *print_ssid(char *buf, const char *ssid, u8 ssid_len)
{
	...
	ssid_len = (((ssid_len)<(32))? (ssid_len):(32));
	while (ssid_len--) {
		if (((* __rt_ctype_table())[*s] & (8+16+32+2+4))) {
			*d++ = *s++;
			continue;
		}
