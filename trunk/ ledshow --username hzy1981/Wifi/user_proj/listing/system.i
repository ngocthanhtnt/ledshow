...
void RCC_Configuration(void)
{
  ...
  RCC_APB2PeriphClockCmd(((u32)0x00000200) | ((u32)0x00000010), ENABLE);

  

   
  
  RCC_APB1PeriphClockCmd(((u32)0x00020000)|((u32)0x00040000)|  ((u32)0x00000001)|((u32)0x00000002),ENABLE);

  RCC_APB2PeriphClockCmd(((u32)0x00004000)|((u32)0x00000004)|  ((u32)0x00000008)|((u32)0x00000010)|((u32)0x00000020)|  ((u32)0x00001000)|((u32)0x00000001),


  ENABLE);
   
  RCC_AHBPeriphClockCmd(((u32)0x00000400), ENABLE);
...
#line 187 "..\\target\\system.c"

    
   
  GPIO_InitStructure.GPIO_Pin = ((u16)0x0100) | ((u16)0x0200) | ((u16)0x0400) | ((u16)0x0800) | ((u16)0x1000);
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
  ...
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
  GPIO_Init(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000)), &GPIO_InitStructure);
  ((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->ODR&=~(1<<1);
...
void adc_init()
{
  ...
  ADC_RegularChannelConfig(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)), ((u8)0x0D), 1, ((u8)0x05));
...
int get_adcval()
{
	return ADC_GetConversionValue(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)));
}
...
void disable_timer(void)
{
	TIM_Cmd(((TIM_TypeDef *) (((u32)0x40000000) + 0x0000)), DISABLE); 
}
...
void timerbase_config(void)
{
  ...
  TIM_TimeBaseStructure.TIM_Period =250*10;
  ...
  TIM_PrescalerConfig(((TIM_TypeDef *) (((u32)0x40000000) + 0x0000)),7199, ((u16)0x0001)); 
...
char get_char(void)
{
   while(!(USART_GetFlagStatus(((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800)), ((u16)0x0020)) == SET)){
   } 
   return (USART_ReceiveData(((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))));
}
