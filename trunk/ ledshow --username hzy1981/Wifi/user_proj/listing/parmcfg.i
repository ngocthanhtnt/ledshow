...
char wireless_dns[4]={202,99,96,68}; 
...
static int get_parmer(unsigned char *str,unsigned char *name,unsigned char *context,unsigned char chr)
{
	...
	while(*context){
		...
		if((memcmp(context,name,strlen((const char *)name))==0)&&
			(*(context+strlen((const char *)name))=='=')){
			parm=context+strlen((const char *)name)+1;
			context+=(strlen((const char *)name)+1);
			while((*context!=chr)&&(*context!='\0')){
				cnt++;
				context++;
			}
			memcpy(str,parm,cnt);
...
const char default_cfg[]={"Route?NET=1&SSID=Newpower_ADHOC&KEY=1234567890123&WIP1=192&WIP2=168&WIP3=010&WIP4=010&MASK1=255&MASK2=255&MASK3=255&MASK4=000&GW1=192&GW2=168&GW3=010&GW4=001&DNS1=202&DNS2=096&DNS3=134&DNS4=133&WMAC0=00&WMAC1=1A&WMAC2=6B&WMAC3=6E&WMAC4=82&WMAC5=0E&OK=%B1%A3%B4%E6"};
#line 214 "..\\main\\parmcfg.c"
...
{
	write_flash(((u32)0x0803F800),buf,len);
}
