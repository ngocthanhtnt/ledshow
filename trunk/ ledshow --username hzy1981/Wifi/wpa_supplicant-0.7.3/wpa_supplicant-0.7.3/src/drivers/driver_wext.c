...
wpa_driver_wext_get_bssid,//getbssid
wpa_driver_wext_get_ssid,//getssid
wpa_driver_wext_set_key,//set_key
wpa_driver_wext_init,//init
wpa_driver_wext_deinit,//deinit
NULL,//setparam
wpa_driver_wext_set_countermeasures,//set_counterme
wpa_driver_wext_deauthenticate,//deauthnticate
wpa_driver_wext_disassociate,//disassociate
wpa_driver_wext_associate,//assicociate
...
NULL,//init2
NULL,//get_interfaces
wpa_driver_wext_scan,//scan2
NULL,//authenticate
NULL,//set_beacon
NULL,//hapd_init
NULL,//hapd_deinit
NULL,//set_ieee8021x //43
NULL,//set_privacy
NULL,//set_seqnum
NULL,//flush //46
NULL,//set_generic_elme
NULL,//read_sta_data
