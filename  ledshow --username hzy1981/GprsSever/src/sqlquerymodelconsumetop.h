#ifndef SQLQUERYMODELCONSUMETOP_H
#define SQLQUERYMODELCONSUMETOP_H

#include <QtSql/QSqlQueryModel>
#include <QtCore/QString>

class SqlQueryModelConsumeTop: public QSqlQueryModel
{
	Q_OBJECT
public:
	SqlQueryModelConsumeTop(QObject *parent=0);
public:
	void setQuery();
