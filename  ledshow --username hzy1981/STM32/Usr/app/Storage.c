...
/*
  //节目边框数据及备份
  {SDI_PROG_BORDER, BORDER_DATA_LEN, MAX_PROG_NUM},
#ifdef  SDI_PROG_BORDER_BK0
  {SDI_PROG_BORDER, BORDER_DATA_LEN, MAX_PROG_NUM},
#endif
#ifdef SDI_PROG_BORDER_BK1
  {SDI_PROG_BORDER, BORDER_DATA_LEN, MAX_PROG_NUM},
#endif
*/
 //文件参数及备份
  {SDI_FILE_PARA, FILE_PARA_LEN, MAX_PROG_NUM * MAX_FILE_NUM},
#ifdef  SDI_FILE_PARA_BK0
  {SDI_FILE_PARA_BK0,  FILE_PARA_LEN, MAX_PROG_NUM * MAX_FILE_NUM},
#endif

  {SDI_ENCRYPTION_DATA1, ENCRYPTION_DATA_LEN, 1},

  {SDI_FILE_PARA_INDEX, FILE_PARA_INDEX_LEN, MAX_PROG_NUM},
#ifdef  SDI_FILE_PARA_INDEX_BK0
  {SDI_FILE_PARA_INDEX_BK0, FILE_PARA_INDEX_LEN, MAX_PROG_NUM},
#endif
/*
  //文件边框数据
   {SDI_FILE_BORDER, BORDER_DATA_LEN, MAX_PROG_NUM * MAX_AREA_NUM * MAX_FILE_NUM},
 #ifdef  SDI_FILE_BORDER_BK0
   {SDI_FILE_BORDER_BK0,  BORDER_DATA_LEN, MAX_PROG_NUM * MAX_AREA_NUM * MAX_FILE_NUM},
 #endif
