...
#define SCAN_INT_DISABLE() TIM_ITConfig(TIM2,TIM_IT_Update|TIM_IT_Trigger,DISABLE)  //使能
#define SCAN_INT_ENABLE()  TIM_ITConfig(TIM2,TIM_IT_Update|TIM_IT_Trigger,ENABLE)

#define STOP_SCAN_TIMER()  SCAN_INT_DISABLE()//TIM_Cmd(TIM2, DISABLE);  //使能TIMx外设  
#define START_SCAN_TIMER() SCAN_INT_ENABLE() //TIM_Cmd(TIM2, ENABLE);  //使能TIMx外设
