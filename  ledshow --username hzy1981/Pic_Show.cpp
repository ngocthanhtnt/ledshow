...
const S_Mode_Func In_Mode_Func[]=
{
  ...
  ,{&Move_Spin_CW, HV_MODE, 1} //顺时针
#endif
#if IN_SPEC_EFFECT_NUM > 20   
  ,{&Move_Spin_CCW, H_MODE, 1}//逆时针覆盖
#endif
#if IN_SPEC_EFFECT_NUM > 21 
  ,{&Move_Up_Snow, H_MODE, 1} //上飘雪
#endif
#if IN_SPEC_EFFECT_NUM > 22   
  ,{&Move_Down_Snow, H_MODE, 1} //下飘雪
#endif
#if IN_SPEC_EFFECT_NUM > 23   
  ,{&Move_Flash, H_MODE, 1} //闪烁
#endif
  ...
  ,{&Move_Up_Laser, H_MODE, 1} //上镭射
#endif
#if IN_SPEC_EFFECT_NUM > 27   
  ,{&Move_Down_Laser, H_MODE, 1} //下镭射
#endif
  ...
  ,{&Move_Up_Tensile, H_MODE, 1}//上拉伸
#endif
#if IN_SPEC_EFFECT_NUM > 30   
  //{&Move_Down_Tensile}//下拉伸
  ,{&Move_Vertical_Tensile, H_MODE, 1}//垂直拉伸
#endif
  ...
  ,{&Move_Horizontal_Window, H_MODE, 1} //水平百叶窗
#endif
#if IN_SPEC_EFFECT_NUM > 35   
  ,{&Move_Vertical_Window, H_MODE, 1} //垂直百叶窗
#endif
#if IN_SPEC_EFFECT_NUM > 36   
  ,{&Move_Left_Compress, H_MODE, 1} //向左压缩
#endif
#if IN_SPEC_EFFECT_NUM > 37   
  ,{&Move_Up_Compress, H_MODE, 1}//向上压缩
#endif
};
