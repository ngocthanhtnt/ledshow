...
**
** Created: Mon Mar 21 12:58:27 2011
...
static const uint qt_meta_data_MainObj[] = {
...
static const char qt_meta_stringdata_MainObj[] = {
    "MainObj\0\0screenChange()\0"
};

const QMetaObject MainObj::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MainObj,
      qt_meta_data_MainObj, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MainObj::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MainObj))
        return static_cast<void*>(const_cast< MainObj*>(this));
