#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-internal-dec.c"
...
#line 25 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-internal-dec.c"
...
#line 27 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-internal-dec.c"
...
#line 28 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-internal-dec.c"
#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes_i.h"
...
#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes.h"
...
#line 19 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes_i.h"
...
extern const unsigned int rcon[10];
extern const unsigned char Td4s[256];
extern const unsigned char rcons[10];

#line 69 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes_i.h"



static  unsigned int rotr(unsigned int val, int bits)
{
	return (val >> bits) | (val << (32 - bits));
}

#line 90 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes_i.h"

#line 103 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes_i.h"



#line 117 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes_i.h"



void rijndaelKeySetupEnc(unsigned int rk[ ], const unsigned char cipherKey[]);

#line 29 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-internal-dec.c"
...
void rijndaelKeySetupDec(unsigned int rk[ ], const unsigned char cipherKey[])
{
	int Nr = 10, i, j;
	unsigned int temp;
...
static void rijndaelDecrypt(const unsigned int rk[ ], const unsigned char ct[16], unsigned char pt[16])
{
	...
	s0 = (((unsigned int)(ct)[0] << 24) ^ ((unsigned int)(ct)[1] << 16) ^ ((unsigned int)(ct)[2] << 8) ^ ((unsigned int)(ct)[3])) ^ rk[0];
	s1 = (((unsigned int)(ct + 4)[0] << 24) ^ ((unsigned int)(ct + 4)[1] << 16) ^ ((unsigned int)(ct + 4)[2] << 8) ^ ((unsigned int)(ct + 4)[3])) ^ rk[1];
	s2 = (((unsigned int)(ct + 8)[0] << 24) ^ ((unsigned int)(ct + 8)[1] << 16) ^ ((unsigned int)(ct + 8)[2] << 8) ^ ((unsigned int)(ct + 8)[3])) ^ rk[2];
	s3 = (((unsigned int)(ct + 12)[0] << 24) ^ ((unsigned int)(ct + 12)[1] << 16) ^ ((unsigned int)(ct + 12)[2] << 8) ^ ((unsigned int)(ct + 12)[3])) ^ rk[3];
...
#line 112 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-internal-dec.c"
	...
	{ (pt)[0] = (unsigned char)((s0) >> 24); (pt)[1] = (unsigned char)((s0) >> 16); (pt)[2] = (unsigned char)((s0) >> 8); (pt)[3] = (unsigned char)(s0); };
	s1 = (Td4s[((t1) >> 24) & 0xff] << 24) ^ (Td4s[((t0) >> 16) & 0xff] << 16) ^ (Td4s[((t3) >> 8) & 0xff] << 8) ^ (Td4s[(t2) & 0xff]) ^ rk[1];
	{ (pt + 4)[0] = (unsigned char)((s1) >> 24); (pt + 4)[1] = (unsigned char)((s1) >> 16); (pt + 4)[2] = (unsigned char)((s1) >> 8); (pt + 4)[3] = (unsigned char)(s1); };
	s2 = (Td4s[((t2) >> 24) & 0xff] << 24) ^ (Td4s[((t1) >> 16) & 0xff] << 16) ^ (Td4s[((t0) >> 8) & 0xff] << 8) ^ (Td4s[(t3) & 0xff]) ^ rk[2];
	{ (pt + 8)[0] = (unsigned char)((s2) >> 24); (pt + 8)[1] = (unsigned char)((s2) >> 16); (pt + 8)[2] = (unsigned char)((s2) >> 8); (pt + 8)[3] = (unsigned char)(s2); };
	s3 = (Td4s[((t3) >> 24) & 0xff] << 24) ^ (Td4s[((t2) >> 16) & 0xff] << 16) ^ (Td4s[((t1) >> 8) & 0xff] << 8) ^ (Td4s[(t0) & 0xff]) ^ rk[3];
	{ (pt + 12)[0] = (unsigned char)((s3) >> 24); (pt + 12)[1] = (unsigned char)((s3) >> 16); (pt + 12)[2] = (unsigned char)((s3) >> 8); (pt + 12)[3] = (unsigned char)(s3); };
}
