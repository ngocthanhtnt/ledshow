...
const static char TCP_TestData[]="This is LwIP TCP Client  ÔÚLuminary Cortex-M3 ÉÏµÄ²âÊÔ£¡\r\n"; 
...
{ 
	...
	(&YeeClient . ipaddr)->addr = htonl(((u32_t)((202) & 0xff) << 24) | ((u32_t)((136) & 0xff) << 16) | ((u32_t)((56) & 0xff) << 8) | (u32_t)((203) & 0xff)); 
	YeeClient.port=80;
	YeeClient.pcb=tcp_new();     
	tcp_bind(YeeClient.pcb,((struct ip_addr *)&ip_addr_any),0);  
