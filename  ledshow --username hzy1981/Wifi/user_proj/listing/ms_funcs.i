#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\ms_funcs.c"
...
#line 16 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\ms_funcs.c"
...
#line 18 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\ms_funcs.c"
...
#line 19 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\ms_funcs.c"
...
#line 20 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\ms_funcs.c"
...
#line 21 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\ms_funcs.c"
...
static int challenge_hash(const unsigned char *peer_challenge, const unsigned char *auth_challenge,
			  const unsigned char *username, size_t username_len,
		      ...
		      unsigned char *password_hash)
{
	...
	len = password_len * 2;
	pos = buf;
	return md4_vector(1, (const unsigned char **) &pos, &len, password_hash);
}
	...
	const unsigned char *nt_response, unsigned char *response)
{
	...
	unsigned char password_hash_hash[16], challenge[8];
...
int get_master_key(const unsigned char *password_hash_hash, const unsigned char *nt_response,
		   unsigned char *master_key)
{
	static const unsigned char magic1[27] = {
...
int get_asymetric_start_key(const unsigned char *master_key, unsigned char *session_key,
			    ...
			    int is_server)
{
	static const unsigned char magic2[84] = {
	...
	static const unsigned char magic3[84] = {
		0x4f, 0x6e, 0x20, 0x74, 0x68, 0x65, 0x20, 0x63, 0x6c, 0x69,
		0x65, 0x6e, 0x74, 0x20, 0x73, 0x69, 0x64, 0x65, 0x2c, 0x20,
		0x74, 0x68, 0x69, 0x73, 0x20, 0x69, 0x73, 0x20, 0x74, 0x68,
		0x65, 0x20, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x20,
	...
	static const unsigned char shs_pad1[40] = {
	...
	static const unsigned char shs_pad2[40] = {
	...
	const unsigned char *password_hash, unsigned char *pw_block)
{
	...
	pos = &pw_block[2 * 256];
	do { (pos)[1] = ((unsigned short) (password_len * 2)) >> 8; (pos)[0] = ((unsigned short) (password_len * 2)) & 0xff; } while (0);
...
int old_nt_password_hash_encrypted_with_new_nt_password_hash(
	...
	unsigned char *encrypted_password_hash)
{
	unsigned char old_password_hash[16], new_password_hash[16];
