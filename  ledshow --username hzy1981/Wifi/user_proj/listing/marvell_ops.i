#line 1 "..\\marvel\\driver\\src\\marvell_ops.c"
...
#line 3 "..\\marvel\\driver\\src\\marvell_ops.c"
...
struct lbs_private * init_marvell_driver(void)
{
  ...
  struct sdio_func *func;
  struct lbs_private *priv;
  ((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->ODR=1?(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->ODR|1<<12):(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->ODR&(~(1<<12)));
  host=stm32_probe();
  ((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->ODR=0?(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->ODR|1<<12):(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->ODR&(~(1<<12)));
  mmc_rescan(host);
  printf("init marvel driver ok!\n");
  card=host->card;
  ...
  if(func){
	  ...
	  printf("cann't find a function device!\n");
  return 0;
}
...
char  lbs_hard_start_xmit(struct lbs_private *priv,struct eth_packet * tx_ethpkt)
{
	...
	if (!tx_ethpkt->len || (tx_ethpkt->len > (1514 + sizeof(struct txpd) + 36))) {
		;
	...
	p802x_hdr = tx_ethpkt->data;
	pkt_len = tx_ethpkt->len;
	 
	
	memcpy(txpd->tx_dest_addr_high, p802x_hdr, 6);
	txpd->tx_packet_length = (pkt_len);
	txpd->tx_packet_location = (sizeof(struct txpd));
	memcpy(&txpd[1], p802x_hdr, (txpd->tx_packet_length));
	priv->resp_len[0] = pkt_len + sizeof(struct txpd);
	;
 free:	
...
{
	__le32 Localpsmode;
	int wait_option=0x0002;
	;
	Localpsmode = (LBS802_11POWERMODECAM);
	lbs_prepare_and_send_command(priv, 0x0021,
			      0x0031,
...
void init_sleep_mode(void)
{
	...
	confirm_sleep.hdr.command = (0x0021);
	confirm_sleep.hdr.size = (sizeof(confirm_sleep));
	confirm_sleep.action = (0x0034);
}
 ...
 void lbs_send_confirmsleep(struct lbs_private *priv)
{
	...
	;
	lbs_hex(0x00002000, "sleep confirm", (u8 *) &confirm_sleep,
