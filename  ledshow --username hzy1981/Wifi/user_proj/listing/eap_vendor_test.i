#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\eap_vendor_test.c"
...
#line 20 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\eap_vendor_test.c"
...
#line 22 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\eap_vendor_test.c"
...
#line 23 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\eap_vendor_test.c"
...
#line 68 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\eap_vendor_test.c"
					       ...
					       const struct wpabuf *reqData)
{
	...
	pos = eap_hdr_validate(0xfffefd, 0xfcfbfaf9, reqData, &len);
	if (pos == 0 || len < 1) {
		ret->ignore = 1;
		return 0;
	}
	...
	if (data->state == INIT && *pos != 1) {
		wpa_printf(0, "EAP-VENDOR-TEST: Unexpected message "
			   "%d in INIT state", *pos);
		ret->ignore = 1;
		return 0;
	}
...
#line 118 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\eap_vendor_test.c"
	}

	ret->ignore = 0;

	wpa_printf(0, "EAP-VENDOR-TEST: Generating Response");
	ret->allowNotifications = 1;

	resp = eap_msg_alloc(0xfffefd, 0xfcfbfaf9, 1,
...
static int eap_vendor_test_isKeyAvailable(struct eap_sm *sm, void *priv)
{
	struct eap_vendor_test_data *data = priv;
...
static unsigned char * eap_vendor_test_getKey(struct eap_sm *sm, void *priv, size_t *len)
{
	struct eap_vendor_test_data *data = priv;
	unsigned char *key;
