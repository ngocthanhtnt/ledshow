#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_common.c"
...
#line 16 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_common.c"
...
#line 18 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_common.c"
...
#line 19 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_common.c"
...
#line 20 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_common.c"
			    ...
			    const struct wpabuf *msg, size_t *plen)
{
	...
	if (wpabuf_len(msg) < sizeof(*hdr)) {
		wpa_printf(0, "EAP: Too short EAP frame");
		return 0;
	}
	...
	if (len < sizeof(*hdr) + 1 || len > wpabuf_len(msg)) {
		wpa_printf(0, "EAP: Invalid EAP length");
		return 0;
	}
	...
	if (*pos == EAP_TYPE_EXPANDED) {
		...
		if (len < sizeof(*hdr) + 8) {
			wpa_printf(0, "EAP: Invalid expanded EAP "
				   "length");
			return 0;
		}
		pos++;
		exp_vendor = ((((unsigned int) (pos)[0]) << 16) | (((unsigned int) (pos)[1]) << 8) | ((unsigned int) (pos)[2]));
		pos += 3;
		exp_type = ((((unsigned int) (pos)[0]) << 24) | (((unsigned int) (pos)[1]) << 16) | (((unsigned int) (pos)[2]) << 8) | ((unsigned int) (pos)[3]));
		pos += 4;
		if (exp_vendor != vendor || exp_type != (unsigned int) eap_type) {
			wpa_printf(0, "EAP: Invalid expanded frame "
				   "type");
			return 0;
		}
		...
		*plen = len - sizeof(*hdr) - 8;
		...
		if (vendor != EAP_VENDOR_IETF || *pos != eap_type) {
			wpa_printf(0, "EAP: Invalid frame type");
			return 0;
		}
			      ...
			      unsigned char code, unsigned char identifier)
{
	...
	hdr->length = (( unsigned short) ((((unsigned short) ((len)) << 8) & 0xff00) | (((unsigned short) ((len)) >> 8) & 0xff)));
...
void eap_update_len(struct wpabuf *msg)
{
	...
	if (wpabuf_len(msg) < sizeof(*hdr))
		return;
	hdr->length = (( unsigned short) ((((unsigned short) ((wpabuf_len(msg))) << 8) & 0xff00) | (((unsigned short) ((wpabuf_len(msg))) >> 8) & 0xff)));
}
...
EapType eap_get_type(const struct wpabuf *msg)
{
	...
	return ((const unsigned char *) wpabuf_head(msg))[sizeof(struct eap_hdr)];
}
