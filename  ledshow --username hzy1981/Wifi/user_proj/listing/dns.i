...
#line 84 "..\\lwIP\\src\\core\\dns.c"


extern unsigned char wireless_dns[4];
...
dns_init()
{
  ...
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_init: initializing\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
{
  if (dns_pcb != 0) {
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_tmr: dns_check_entries\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    dns_check_entries();
  }
}

#line 448 "..\\lwIP\\src\\core\\dns.c"
...
{
  u8_t i;
#line 481 "..\\lwIP\\src\\core\\dns.c"

   
  for (i = 0; i < 4; ++i) {
    if ((dns_table[i].state == 3) &&
        (strcmp(name, dns_table[i].name) == 0)) {
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_lookup: \"%s\": found = ", name);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", &(dns_table[i]. ipaddr) != 0 ? (u16_t)(ntohl((&(dns_table[i]. ipaddr))->addr) >> 24) & 0xff : 0, &(dns_table[i]. ipaddr) != 0 ? (u16_t)(ntohl((&(dns_table[i]. ipaddr))->addr) >> 16) & 0xff : 0, &(dns_table[i]. ipaddr) != 0 ? (u16_t)(ntohl((&(dns_table[i]. ipaddr))->addr) >> 8) & 0xff : 0, &(dns_table[i]. ipaddr) != 0 ? (u16_t)ntohl((&(dns_table[i]. ipaddr))->addr) & 0xff : 0);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
dns_send(u8_t numdns, const char* name, u8_t id)
{
  ...
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_send: dns_servers[%" "4d" "] \"%s\": request\n", (u16_t)(numdns), name);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
dns_check_entry(u8_t i)
{
  ...
  switch(pEntry->state) {
      ...
      if (--pEntry->tmr == 0) {
        if (++pEntry->retries == 4) {
          if ((pEntry->numdns+1<2) && (dns_servers[pEntry->numdns+1].addr!=0)) {
            ...
            do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_check_entry: \"%s\": timeout\n", pEntry->name);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    ...
    case 3: {
      ...
      if (--pEntry->ttl == 0) {
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_check_entry: \"%s\": flush\n", pEntry->name);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
#line 753 "..\\lwIP\\src\\core\\dns.c"
  ...
  if (p->tot_len > 512) {
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_recv: pbuf too big\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  ...
  if (p->tot_len < (12 + 4 + 10)) {
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_recv: pbuf too small\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
     
    goto memerr1;
  }

#line 781 "..\\lwIP\\src\\core\\dns.c"
    ...
    if (i < 4) {
      ...
      if(pEntry->state == 2) {
        ...
        if (((hdr->flags1 & 0x80) == 0) || (pEntry->err != 0) || (nquestions != 1)) {
          do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_recv: \"%s\": error in flags\n", pEntry->name);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        ...
        if (dns_compare_name((unsigned char *)(pEntry->name), (unsigned char *)dns_payload + 12) != 0) {
          do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_recv: \"%s\": response not match to query\n", pEntry->name);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        ...
        while(nanswers > 0) {
          ...
          if((ntohs(ans.type) == 1) && (ntohs(ans.class) == 1) && (ntohs(ans.len) == sizeof(struct ip_addr)) ) {
            ...
            do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_recv: \"%s\": response = ", pEntry->name);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
            do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (&(pEntry->ipaddr)) != 0 ? (u16_t)(ntohl(((&(pEntry->ipaddr)))->addr) >> 24) & 0xff : 0, (&(pEntry->ipaddr)) != 0 ? (u16_t)(ntohl(((&(pEntry->ipaddr)))->addr) >> 16) & 0xff : 0, (&(pEntry->ipaddr)) != 0 ? (u16_t)(ntohl(((&(pEntry->ipaddr)))->addr) >> 8) & 0xff : 0, (&(pEntry->ipaddr)) != 0 ? (u16_t)ntohl(((&(pEntry->ipaddr)))->addr) & 0xff : 0);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
            do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        ...
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_recv: \"%s\": error in response\n", pEntry->name);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
dns_enqueue(const char *name, dns_found_callback found, void *callback_arg)
{
  ...
  if (i == 4) {
    if ((lseqi >= 4) || (dns_table[lseqi].state != 3)) {
      ...
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_enqueue: \"%s\": DNS entries table is full\n", name);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      return -1;
    } else {
  ...
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("dns_enqueue: \"%s\": use DNS entry %" "4d" "\n", name, (u16_t)(i));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
