...
#line 18 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\des-internal.c"
...
#line 20 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\des-internal.c"
...
#line 21 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\des-internal.c"
#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\des_i.h"
...
void des_key_setup(const unsigned char *key, unsigned int *ek, unsigned int *dk);
void des_block_encrypt(const unsigned char *plain, const unsigned int *ek, unsigned char *crypt);
void des_block_decrypt(const unsigned char *crypt, const unsigned int *dk, unsigned char *plain);

void des3_key_setup(const unsigned char *key, struct des3_key_s *dkey);
void des3_encrypt(const unsigned char *plain, const struct des3_key_s *key, unsigned char *crypt);
void des3_decrypt(const unsigned char *crypt, const struct des3_key_s *key, unsigned char *plain);

#line 22 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\des-internal.c"
...
#line 53 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\des-internal.c"
...
static void cookey(const unsigned int *raw1, unsigned int *keyout)
{
	unsigned int *cook;
...
static void deskey(const unsigned char *key, int decrypt, unsigned int *keyout)
{
...
static void desfunc(unsigned int *block, const unsigned int *keys)
{
...
void des_encrypt(const unsigned char *clear, const unsigned char *key, unsigned char *cypher)
{
	...
	work[0] = ((((unsigned int) (clear)[0]) << 24) | (((unsigned int) (clear)[1]) << 16) | (((unsigned int) (clear)[2]) << 8) | ((unsigned int) (clear)[3]));
	work[1] = ((((unsigned int) (clear + 4)[0]) << 24) | (((unsigned int) (clear + 4)[1]) << 16) | (((unsigned int) (clear + 4)[2]) << 8) | ((unsigned int) (clear + 4)[3]));
	desfunc(work, ek);
	do { (cypher)[0] = (unsigned char) ((((unsigned int) (work[0])) >> 24) & 0xff); (cypher)[1] = (unsigned char) ((((unsigned int) (work[0])) >> 16) & 0xff); (cypher)[2] = (unsigned char) ((((unsigned int) (work[0])) >> 8) & 0xff); (cypher)[3] = (unsigned char) (((unsigned int) (work[0])) & 0xff); } while (0);
	do { (cypher + 4)[0] = (unsigned char) ((((unsigned int) (work[1])) >> 24) & 0xff); (cypher + 4)[1] = (unsigned char) ((((unsigned int) (work[1])) >> 16) & 0xff); (cypher + 4)[2] = (unsigned char) ((((unsigned int) (work[1])) >> 8) & 0xff); (cypher + 4)[3] = (unsigned char) (((unsigned int) (work[1])) & 0xff); } while (0);
...
{
	unsigned int work[2];
	work[0] = ((((unsigned int) (plain)[0]) << 24) | (((unsigned int) (plain)[1]) << 16) | (((unsigned int) (plain)[2]) << 8) | ((unsigned int) (plain)[3]));
	work[1] = ((((unsigned int) (plain + 4)[0]) << 24) | (((unsigned int) (plain + 4)[1]) << 16) | (((unsigned int) (plain + 4)[2]) << 8) | ((unsigned int) (plain + 4)[3]));
	desfunc(work, ek);
	do { (crypt)[0] = (unsigned char) ((((unsigned int) (work[0])) >> 24) & 0xff); (crypt)[1] = (unsigned char) ((((unsigned int) (work[0])) >> 16) & 0xff); (crypt)[2] = (unsigned char) ((((unsigned int) (work[0])) >> 8) & 0xff); (crypt)[3] = (unsigned char) (((unsigned int) (work[0])) & 0xff); } while (0);
	do { (crypt + 4)[0] = (unsigned char) ((((unsigned int) (work[1])) >> 24) & 0xff); (crypt + 4)[1] = (unsigned char) ((((unsigned int) (work[1])) >> 16) & 0xff); (crypt + 4)[2] = (unsigned char) ((((unsigned int) (work[1])) >> 8) & 0xff); (crypt + 4)[3] = (unsigned char) (((unsigned int) (work[1])) & 0xff); } while (0);
}
...
{
	unsigned int work[2];
	work[0] = ((((unsigned int) (crypt)[0]) << 24) | (((unsigned int) (crypt)[1]) << 16) | (((unsigned int) (crypt)[2]) << 8) | ((unsigned int) (crypt)[3]));
	work[1] = ((((unsigned int) (crypt + 4)[0]) << 24) | (((unsigned int) (crypt + 4)[1]) << 16) | (((unsigned int) (crypt + 4)[2]) << 8) | ((unsigned int) (crypt + 4)[3]));
	desfunc(work, dk);
	do { (plain)[0] = (unsigned char) ((((unsigned int) (work[0])) >> 24) & 0xff); (plain)[1] = (unsigned char) ((((unsigned int) (work[0])) >> 16) & 0xff); (plain)[2] = (unsigned char) ((((unsigned int) (work[0])) >> 8) & 0xff); (plain)[3] = (unsigned char) (((unsigned int) (work[0])) & 0xff); } while (0);
	do { (plain + 4)[0] = (unsigned char) ((((unsigned int) (work[1])) >> 24) & 0xff); (plain + 4)[1] = (unsigned char) ((((unsigned int) (work[1])) >> 16) & 0xff); (plain + 4)[2] = (unsigned char) ((((unsigned int) (work[1])) >> 8) & 0xff); (plain + 4)[3] = (unsigned char) (((unsigned int) (work[1])) & 0xff); } while (0);
}
