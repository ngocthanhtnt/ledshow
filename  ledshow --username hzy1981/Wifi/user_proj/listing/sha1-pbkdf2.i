#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha1-pbkdf2.c"
...
#line 16 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha1-pbkdf2.c"
...
#line 18 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha1-pbkdf2.c"
...
#line 19 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha1-pbkdf2.c"
...
#line 20 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha1-pbkdf2.c"
...
#line 21 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\sha1-pbkdf2.c"
			 ...
			 unsigned char *digest)
{
	...
	if (hmac_sha1_vector((unsigned char *) passphrase, passphrase_len, 2, addr, len,
			     tmp))
		return -1;
	memcpy(digest, tmp, 20);

	for (i = 1; i < iterations; i++) {
		if (hmac_sha1((unsigned char *) passphrase, passphrase_len, tmp,
			      20, tmp2))
			return -1;
		memcpy(tmp, tmp2, 20);
		for (j = 0; j < 20; j++)
