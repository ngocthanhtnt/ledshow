...
static u8_t ram_heap[((((4*1024)) + 4 - 1) & ~(4-1)) + (2*(((sizeof(struct mem)) + 4 - 1) & ~(4-1))) + 4];
...
{
  struct mem *mem;
  extern int wpa_debug_level;wpa_debug_level = 1000;;
  ...
  ram_end = (struct mem *)&ram[((((4*1024)) + 4 - 1) & ~(4-1))];
  ram_end->used = 1;
...
mem_free(void *rmem)
{
  ...
  if (rmem == 0) {
    do { if ( ((0x00U | 0x40U | 2) & 0x80U) && ((0x00U | 0x40U | 2) & 0x80U) && ((s16_t)((0x00U | 0x40U | 2) & 0x03) >= 0x00)) { do {printf ("mem_free(p == NULL) was called.\n");} while(0); if ((0x00U | 0x40U | 2) & 0x08U) { while(1); } } } while(0);
    return;
  }
  ;
  ...
  if ((u8_t *)rmem < (u8_t *)ram || (u8_t *)rmem >= (u8_t *)ram_end) {
    ;
    do { if ( ((0x00U | 3) & 0x80U) && ((0x00U | 3) & 0x80U) && ((s16_t)((0x00U | 3) & 0x03) >= 0x00)) { do {printf ("mem_free: illegal memory\n");} while(0); if ((0x00U | 3) & 0x08U) { while(1); } } } while(0);
...
mem_realloc(void *rmem, mem_size_t newsize)
{
  ...
  if ((u8_t *)rmem < (u8_t *)ram || (u8_t *)rmem >= (u8_t *)ram_end) {
    ;
    do { if ( ((0x00U | 3) & 0x80U) && ((0x00U | 3) & 0x80U) && ((s16_t)((0x00U | 3) & 0x03) >= 0x00)) { do {printf ("mem_realloc: illegal memory\n");} while(0); if ((0x00U | 3) & 0x08U) { while(1); } } } while(0);
...
mem_malloc(mem_size_t size)
{
  ...
  ;
    ...
    for (ptr = (u8_t *)lfree - ram; ptr < ((((4*1024)) + 4 - 1) & ~(4-1)) - size;
         ptr = ((struct mem *)&ram[ptr])->next) {
      mem = (struct mem *)&ram[ptr];
#line 541 "..\\lwIP\\src\\core\\mem.c"
  ...
  do { if ( ((0x00U | 2) & 0x80U) && ((0x00U | 2) & 0x80U) && ((s16_t)((0x00U | 2) & 0x03) >= 0x00)) { do {printf ("mem_malloc: could not allocate %" "4d" " bytes\n", (s16_t)size);} while(0); if ((0x00U | 2) & 0x08U) { while(1); } } } while(0);
  ;
  ;
  ;
  return 0;
