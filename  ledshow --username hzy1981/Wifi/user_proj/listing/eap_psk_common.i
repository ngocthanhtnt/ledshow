#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_psk_common.c"
...
#line 16 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_psk_common.c"
...
#line 18 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_psk_common.c"
...
#line 19 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_psk_common.c"
...
#line 20 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_psk_common.c"
#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_psk_common.h"
...
#line 25 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_psk_common.h"
...
int  eap_psk_key_setup(const unsigned char *psk, unsigned char *ak, unsigned char *kdk);
int  eap_psk_derive_keys(const unsigned char *kdk, const unsigned char *rand_p, unsigned char *tek,
				     unsigned char *msk, unsigned char *emsk);

#line 21 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_common\\eap_psk_common.c"
...
int eap_psk_derive_keys(const unsigned char *kdk, const unsigned char *rand_p, unsigned char *tek, unsigned char *msk,
			unsigned char *emsk)
{
	...
	for (i = 0; i < 64 / 16; i++) {
		hash[16 - 1] ^= counter;
		if (aes_128_encrypt_block(kdk, hash, &msk[i * 16]))
			return -1;
		hash[16 - 1] ^= counter;
		counter++;
	}
