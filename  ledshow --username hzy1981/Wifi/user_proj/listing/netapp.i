...
{ 
    ...
    UdpPcb=udp_new();                                       
    udp_bind(UdpPcb,((struct ip_addr *)&ip_addr_any),8080);                       
    (&ipaddr)->addr = htonl(((u32_t)((192) & 0xff) << 24) | ((u32_t)((168) & 0xff) << 16) | ((u32_t)((10) & 0xff) << 8) | (u32_t)((100) & 0xff));
    udp_sendto(UdpPcb,p,&ipaddr,8080);                        
    udp_sendto(UdpPcb,p,&ipaddr,8080); 
    udp_sendto(UdpPcb,p,&ipaddr,8080); 
    udp_recv(UdpPcb,UDP_Receive,0);                       
} 
...
{ 
  TcpClient.connected=1;
  (&TcpClient . ipaddr)->addr = htonl(((u32_t)((192) & 0xff) << 24) | ((u32_t)((168) & 0xff) << 16) | ((u32_t)((10) & 0xff) << 8) | (u32_t)((100) & 0xff)); 
  TcpClient.port=8080;
  TcpClient.pcb=tcp_new();     
  tcp_bind(TcpClient.pcb,((struct ip_addr *)&ip_addr_any),0);  
...
server_recv(void *arg, struct tcp_pcb *pcb, struct pbuf *p, err_t err)
{
  if(err == 0 && p != 0) {
	...
	{
		((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->ODR=0?(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->ODR|1<<6):(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->ODR&(~(1<<6)));
	...
	{
		((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->ODR=1?(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->ODR|1<<6):(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->ODR&(~(1<<6)));
...
void tcp_server_init(void)
{
  struct tcp_pcb *pcb;
  pcb = tcp_new();
  tcp_bind(pcb, ((struct ip_addr *)&ip_addr_any),8080);
