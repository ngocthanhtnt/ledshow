#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-internal-enc.c"
...
#line 25 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-internal-enc.c"
...
#line 27 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-internal-enc.c"
...
#line 28 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-internal-enc.c"
...
#line 29 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-internal-enc.c"

void rijndaelEncrypt(const unsigned int rk[ ], const unsigned char pt[16], unsigned char ct[16])
{
	...
	s0 = (((unsigned int)(pt)[0] << 24) ^ ((unsigned int)(pt)[1] << 16) ^ ((unsigned int)(pt)[2] << 8) ^ ((unsigned int)(pt)[3])) ^ rk[0];
	s1 = (((unsigned int)(pt + 4)[0] << 24) ^ ((unsigned int)(pt + 4)[1] << 16) ^ ((unsigned int)(pt + 4)[2] << 8) ^ ((unsigned int)(pt + 4)[3])) ^ rk[1];
	s2 = (((unsigned int)(pt + 8)[0] << 24) ^ ((unsigned int)(pt + 8)[1] << 16) ^ ((unsigned int)(pt + 8)[2] << 8) ^ ((unsigned int)(pt + 8)[3])) ^ rk[2];
	s3 = (((unsigned int)(pt + 12)[0] << 24) ^ ((unsigned int)(pt + 12)[1] << 16) ^ ((unsigned int)(pt + 12)[2] << 8) ^ ((unsigned int)(pt + 12)[3])) ^ rk[3];
...
#line 68 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\crypto\\aes-internal-enc.c"
	...
	{ (ct)[0] = (unsigned char)((s0) >> 24); (ct)[1] = (unsigned char)((s0) >> 16); (ct)[2] = (unsigned char)((s0) >> 8); (ct)[3] = (unsigned char)(s0); };
	s1 = ((Te0[((t1) >> 24) & 0xff] << 8) & 0xff000000) ^ (Te0[((t2) >> 16) & 0xff] & 0x00ff0000) ^ (Te0[((t3) >> 8) & 0xff] & 0x0000ff00) ^ ((Te0[(t0) & 0xff] >> 8) & 0x000000ff) ^ rk[1];
	{ (ct + 4)[0] = (unsigned char)((s1) >> 24); (ct + 4)[1] = (unsigned char)((s1) >> 16); (ct + 4)[2] = (unsigned char)((s1) >> 8); (ct + 4)[3] = (unsigned char)(s1); };
	s2 = ((Te0[((t2) >> 24) & 0xff] << 8) & 0xff000000) ^ (Te0[((t3) >> 16) & 0xff] & 0x00ff0000) ^ (Te0[((t0) >> 8) & 0xff] & 0x0000ff00) ^ ((Te0[(t1) & 0xff] >> 8) & 0x000000ff) ^ rk[2];
	{ (ct + 8)[0] = (unsigned char)((s2) >> 24); (ct + 8)[1] = (unsigned char)((s2) >> 16); (ct + 8)[2] = (unsigned char)((s2) >> 8); (ct + 8)[3] = (unsigned char)(s2); };
	s3 = ((Te0[((t3) >> 24) & 0xff] << 8) & 0xff000000) ^ (Te0[((t0) >> 16) & 0xff] & 0x00ff0000) ^ (Te0[((t1) >> 8) & 0xff] & 0x0000ff00) ^ ((Te0[(t2) & 0xff] >> 8) & 0x000000ff) ^ rk[3];
	{ (ct + 12)[0] = (unsigned char)((s3) >> 24); (ct + 12)[1] = (unsigned char)((s3) >> 16); (ct + 12)[2] = (unsigned char)((s3) >> 8); (ct + 12)[3] = (unsigned char)(s3); };
}
