#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\mschapv2.c"
...
#line 16 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\mschapv2.c"
...
#line 18 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\mschapv2.c"
...
#line 19 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\mschapv2.c"
...
#line 20 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\mschapv2.c"
...
int mschapv2_derive_response(const unsigned char *identity, size_t identity_len,
			     const unsigned char *password, size_t password_len,
			     int pwhash,
			     const unsigned char *auth_challenge,
			     const unsigned char *peer_challenge,
			     ...
			     unsigned char *master_key)
{
	...
	wpa_hexdump_ascii(0, "MSCHAPV2: Identity",
			  identity, identity_len);
	username_len = identity_len;
	username = mschapv2_remove_domain(identity, &username_len);
	wpa_hexdump_ascii(0, "MSCHAPV2: Username",
			  username, username_len);

	wpa_hexdump(0, "MSCHAPV2: auth_challenge",
		    auth_challenge, 16);
	wpa_hexdump(0, "MSCHAPV2: peer_challenge",
		    peer_challenge, 16);
	wpa_hexdump_ascii(0, "MSCHAPV2: username",
			  username, username_len);
	...
	if (pwhash) {
		wpa_hexdump_key(0, "MSCHAPV2: password hash",
		...
		wpa_hexdump_ascii_key(0, "MSCHAPV2: password",
				      password, password_len);
	...
	wpa_hexdump(0, "MSCHAPV2: NT Response",
		    nt_response, 24);
	wpa_hexdump(0, "MSCHAPV2: Auth Response",
		    auth_response, 20);
	...
	wpa_hexdump_key(0, "MSCHAPV2: Master Key",
			master_key, 16);
...
int mschapv2_verify_auth_response(const unsigned char *auth_response,
				  const unsigned char *buf, size_t buf_len)
{
	unsigned char recv_response[20];
	if (buf_len < 2 + 2 * 20 ||
	    buf[0] != 'S' || buf[1] != '=' ||
