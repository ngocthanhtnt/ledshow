#line 1 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\eap_otp.c"
...
#line 16 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\eap_otp.c"
...
#line 18 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\eap_otp.c"
...
#line 19 "..\\wpa_supplicant-0.7.3\\wpa_supplicant-0.7.3\\src\\eap_peer\\eap_otp.c"
				       ...
				       const struct wpabuf *reqData)
{
	...
	wpa_hexdump_ascii(0, "EAP-OTP: Request message",
			  pos, len);
	...
	if (password == 0) {
		wpa_printf(0, "EAP-OTP: Password not configured");
	...
	wpa_hexdump_ascii_key(0, "EAP-OTP: Response",
			      password, password_len);

	if (otp) {
		wpa_printf(0, "EAP-OTP: Forgetting used password");
